...
{"id":2,"name":"Kennan","email":"kdiben1@tinypic.com","gender":"M","speak":"Hello, my name is Kennan"},
...
for(let i=0; i<interns.length;i++){
  let speakName = interns[i].name;
  interns.speak=function(speakName){
    // console.log("Hello, my name is " + speakName + "!");
  }
}
// console.log(interns);
